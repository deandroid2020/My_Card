...
public class Fine_payment_alert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fine_payment_alert);
        ...
        NavigationView nav_view= findViewById(R.id.Fine_payment_alert_navigation_view);
    ...
    private void initViews() {
        mDrawerLayout = findViewById(R.id.Fine_payment_alert_drawer_layout);
        setUpToolbar();
