...
public class Deanship extends AppCompatActivity {
    ...
    private String TAG = Deanship.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavigationView nav_view= findViewById(R.id.deanship_navigation_view);
    ...
    private void initViews() {
        mDrawerLayout = findViewById(R.id.deanship_drawer_layout);
        setUpToolbar();
    ...
    private void GetDeanInfo(final  int User_ID) {
        // Tag used to cancel the request
        String tag_string_req = "req_login";

        StringRequest strReq = new StringRequest(Request.Method.POST, WebServices.URL_GetDean_Info, new Response.Listener<String>()
        {
            @Override
